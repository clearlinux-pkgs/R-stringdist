...
Version  : 0.9.14
Release  : 42
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/stringdist_0.9.14.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/stringdist_0.9.14.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735111858
